  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-6">
       ...
       <select
  className="w-full border border-gray-300 rounded-lg px-3 py-2 mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500  text-gray-400"
>
  {/* Placeholder shown in box only */}
  <option value="" className=" " >
    Plaid Checking
  </option>

  {/* Actual options */}
  <option value="savings"  className=" ">Savings Account</option>
  <option value="credit" className="">Credit Card</option>
</select>
